...
public:
  ...
  Problem(int noc = 10, int demand_range = 40, int nov = 5, int capacity = 80, int grid_range = 20, std::string distribution = "uniform", int n_clusters = 5, int cluster_range = 10);
};
