...
public:
  ...
  Problem(int noc = 10, int demand_range = 4, int nov = 4, int capacity = 10, int grid_range = 1000, std::string distribution = "uniform", int n_clusters = 5, int cluster_range = 10);
};
