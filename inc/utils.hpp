...
public:
  ...
  Problem(int noc = 1000, int demand_range = 40, int nov = 25, int capacity = 1600, int grid_range = 2000, std::string distribution = "uniform", int n_clusters = 5, int cluster_range = 10);
};
